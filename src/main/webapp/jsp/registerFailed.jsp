...
<body>
	...
	<div class="container">
		...
		<form action="<%=request.getContextPath() %>/register" method="post">
			...
			<div class="row">
				<div class="col-lg-12">
					<span class="text-success">请点击 <a href="<%=request.getContextPath() %>/login" class="btn btn-warning">登陆</a> 进行登陆，或者等待5秒，系统会自动跳转到登陆页面!</span>
					<% response.setHeader("refresh","5;URL="+request.getContextPath()+"/loadLogin");%>
				</div>
			</div>
